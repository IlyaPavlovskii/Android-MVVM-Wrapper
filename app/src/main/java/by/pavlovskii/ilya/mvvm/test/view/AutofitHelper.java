...
public class AutofitHelper {
    ...
    private static void autofit(TextView view, TextPaint paint, float minTextSize, float maxTextSize,
        ...
        Timber.d("autofit. Min ts: %f, Max ts: %f, Max lines: %d W: %d", minTextSize, maxTextSize, maxLines, targetWidth);
        if (targetWidth <= 0) {
            return;
        }
    ...
    private ArrayList<AutofitHelper.OnTextSizeChangeListener> mListeners;
    ...
    /**
     * Adds an {@link AutofitHelper.OnTextSizeChangeListener} to the list of those whose methods are called
     * whenever the {@link TextView}'s {@code textSize} changes.
     */
    public AutofitHelper addOnTextSizeChangeListener(AutofitHelper.OnTextSizeChangeListener listener) {
        if (mListeners == null) {
     ...
     */
    public AutofitHelper removeOnTextSizeChangeListener(AutofitHelper.OnTextSizeChangeListener listener) {
        if (mListeners != null) {
    ...
    public void setRawMaxTextSize(float size) {
    ...
    private void sendTextSizeChange(float textSize, float oldTextSize) {
        ...
        for (AutofitHelper.OnTextSizeChangeListener listener : mListeners) {
